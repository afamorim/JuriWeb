	...
	<table width="98%"  border="0" cellspacing="2" cellpadding="2">
	  ...
	  <pg:pager url="${pageContext.request.requestURL}" 
	   ...
	   <c:forEach items="${requestScope.children}" var="item">
		  <pg:item>
			  <tr class="td02" onMouseOver="this.style.backgroundColor='#eeeeee'" onMouseOut="this.style.backgroundColor='#FFE8CC'" onClick="javascript:download(${item.codigo});" style="cursor:hand">
			    <td>${item.nome}</td>
