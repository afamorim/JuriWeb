	...
	<head>
		...
		<script language="JavaScript" type="text/JavaScript">
			...
			function exportar(){
				...
				pessoaNome = window.document.forms[0].pessoaNome.value;
				url = '<c:url value="/admin/Processo/ProcessoClienteListReport?reportType=1"/>&pessoaCodigo=' + pessoaCodigo + '&juizoCodigo=' + juizoCodigo + '&orgaoJudiciarioCodigo=' + orgaoJudiciarioCodigo + '&classeProcessoCodigo=' + classeProcessoCodigo + '&numero=' + numero + "&pessoaNome=" + pessoaNome;
				if (pessoaCodigo != ""){
		...
		<table border="0" cellspacing="1" cellpadding="2">
			 <tr>
				...
				<td>
					...
					<span style="valign:bottom;style="cursor:hand"">
