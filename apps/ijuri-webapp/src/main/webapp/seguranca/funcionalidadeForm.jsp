	...
	<html>
		<head>
			...
			<script>
				...
				function salva(){
					funcoes = document.forms[0].elements['funcionalidadeForm:strFuncoes'];
				...
				<table width="100%">
					...
					<tr>
						...
						<td valign="top">
							<table class="box">
								<tr>
									<td class="tituloBox" colspan="2" align="center">
										<h:outputText value="#{properties['lb_funcionalidadeForm']}"/>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<h:inputText id="descricao" value="#{FuncionalidadeBean.funcionalidade.descricao}" 
										...
										<table border="0" align="left" width="70%">
											<tr>
												<td colspan="3" align="center">
													<h:outputText value="#{properties['lb_funcoes']}" 
														styleClass="texto"/>
												</td>
											</tr>
											<tr>
												<td width="45%" align="center">
													<t:selectManyListbox size="5" id="nfuncoes" styleClass="texto" value="">
														...
														<t:selectItems value="#{FuncionalidadeBean.nfuncoes}" var="nfuncao" 
															itemLabel="#{nfuncao.nome}" itemValue="#{nfuncao.codigo}"/>
													</t:selectManyListbox>
												</td>
												<td width="10%" align="center">
													<h:commandButton value=">>" type="button" 
														onclick="transfere(document.forms[0].elements['funcionalidadeForm:nfuncoes'], document.forms[0].elements['funcionalidadeForm:strFuncoes']);"/><br><br>
													<h:commandButton value="<<" type="button" 
														onclick="transfere(document.forms[0].elements['funcionalidadeForm:strFuncoes'], document.forms[0].elements['funcionalidadeForm:nfuncoes']);"/>
												</td>
												<td width="45%" align="center">
													<t:selectManyListbox size="5" id="strFuncoes" styleClass="texto" 
														value="#{FuncionalidadeBean.strFuncoes}" validator="#{FuncionalidadeBean.validaFuncao}">
														<f:convertNumber integerOnly="true"/>
														<t:selectItems var="funcao" value="#{FuncionalidadeBean.funcoes}" 
															itemLabel="#{funcao.nome}" itemValue="#{funcao.codigo}" />
													</t:selectManyListbox>
												</td>
											</tr>
										</table>
								...
								<tr>
									<td colspan="2" >
										<h:commandButton value="Salvar" onclick="setAcao(document.forms[0], 'Salva_Funcionalidade'); salva();" 
											action="#{FuncionalidadeBean.salvar}" />
										&nbsp;
