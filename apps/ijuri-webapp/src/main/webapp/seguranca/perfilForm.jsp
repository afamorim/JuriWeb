	...
	<html>
		<head>
			...
			<script>
				...
				function salva(){
					funcionalidades = document.forms[0].elements['perfilForm:strFuncionalidades'];
											...
											<tr>
												<td width="45%" align="center">
													<t:selectManyListbox size="5" id="nfuncionalidades" styleClass="texto" value="">
														...
														<t:selectItems value="#{PerfilBean.nfuncionalidades}" var="nfuncionalidade" 
															itemLabel="#{nfuncionalidade.nome}" itemValue="#{nfuncionalidade.codigo}" />
													</t:selectManyListbox>
												</td>
												<td width="10%" align="center">
													<h:commandButton value=">>" type="button" 
														onclick="transfere(document.forms[0].elements['perfilForm:nfuncionalidades'], document.forms[0].elements['perfilForm:strFuncionalidades']);"/>
													<br><br>
													<h:commandButton value="<<" type="button" 
														onclick="transfere(document.forms[0].elements['perfilForm:strFuncionalidades'], document.forms[0].elements['perfilForm:nfuncionalidades']);"/>
												</td>
												<td width="45%" align="center">
													<t:selectManyListbox size="5" id="strFuncionalidades"  styleClass="texto" value="#{PerfilBean.strFuncionalidades}" 
														validator="#{PerfilBean.validaFuncao}">
														<f:convertNumber integerOnly="true"/>
														<t:selectItems value="#{PerfilBean.funcionalidades}" var="funcionalidade" itemLabel="#{funcionalidade.nome}" 
															itemValue="#{funcionalidade.codigo}" />
													</t:selectManyListbox>
												</td>
											</tr>
										</table>
