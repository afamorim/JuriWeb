								...
								<tr>
									<td colspan="2">
										<t:panelGrid columns="2" width="80%" >
											...
											<t:selectOneMenu id="perfis" value="#{UsuarioBean.usuario.perfil.codigo}" style="width:290" 
												required="true">
												<f:convertNumber integerOnly="true"/>
												<f:selectItem itemLabel="#{properties['lb_selecione']}" itemValue=""/>
												<t:selectItems value="#{UsuarioBean.perfis}" var="perfil" itemLabel="#{perfil.nome}" 
